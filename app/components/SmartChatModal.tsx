...
export default function SmartChatModal({ isOpen, onClose }: SmartChatModalProps) {
  useEffect(() => {
    if (isOpen) {
          ...
          <div className="flex justify-between items-center p-4 border-b border-gray-800">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-r from-[#00f0ff] to-[#b000ff] rounded-lg flex items-center justify-center">
                <span className="font-black text-black text-sm">AI</span>
              </div>
              <h3 className="text-white font-bold">Smart AI Team</h3>
            </div>
            <button 
              onClick={onClose} 
